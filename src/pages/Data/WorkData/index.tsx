...
import { Tabs, Row, Col, Tooltip, Radio, Table, DatePicker, Divider } from 'antd';
...
const WorkData: React.FC<IProps> = props => {
  ...
  const tableData2 = [{ a1: '2022-09-10', a2: 10, a3: 100, a4: 1, a5: 10, a6: 20, a7: 10, a8: 23, a9: '查看详情' }];
  ...
  return (
    <div className={classnames(styles.workData, 'garrContainer')} ref={Wrapper}>
      ...
      {accessKey === '2' && (
        <div className={styles.oneContent} style={{ marginTop: '24px' }}>
          <Table columns={columns2} dataSource={tableData2} scroll={{ y: 300, x: '100vw' }} />
        </div>
      )}
    </div>
  );
