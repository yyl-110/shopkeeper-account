...
export default ({ customProps: { onSend, onStep, onStop, sending, template, time, text, ...rest }, ...props }) => {
  ...
  return (
    <Form.Item shouldUpdate noStyle>
      <div className={styles['capthcha-item']}>
        ...
        <Button className={styles['btn']} loading={sending} disabled={disabled} size="large" onClick={onSend}>
          {sending ? '发送中...' : btnText}
        </Button>
      </div>
    </Form.Item>
