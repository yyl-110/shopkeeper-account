  ...
  },
  {
    ...
    title: (
      <>
        ...
        <QrCode value={typeof window !== 'undefined' ? window.location.href : ''} renderAs="svg" size={94} level="Q" />
      </>
    ),
  },
];
...
const ShareButton = React.forwardRef(({ icon, children, ...props }, ref) => {
  ...
  return (
    <Popover overlayClassName="popover-menu" content={popoveMenu} arrowPointAtCenter placement="rightTop">
      <div>
